...
const UI_STRINGS = {
  en: {
    ...
    brandDirectoryTitle: "Brand Directory",
    brandDirectorySubtitle: "Brand/category/store-count data synced from Google Sheets.",
    brandCategoryLabel: "Category",
    brandStoreLabel: "Stores",
    brandMenuLabel: "Menus",
    brandLoading: "Loading Google Sheets data...",
    brandNotFound: "No matched data",
    brandSourcePrefix: "Source",
    brandSourceGoogleSheet: "Google Sheets",
  ...
  ko: {
    ...
    brandDirectoryTitle: "치킨 브랜드 소개",
    brandDirectorySubtitle: "브랜드명/분류/매장 수 정보는 구글 시트와 동기화됩니다.",
    brandCategoryLabel: "분류",
    brandStoreLabel: "매장 수",
    brandMenuLabel: "서비스 메뉴",
    brandLoading: "구글 시트 데이터를 불러오는 중...",
    brandNotFound: "매칭 데이터 없음",
    brandSourcePrefix: "출처",
    brandSourceGoogleSheet: "구글 시트",
  ...
  zh: {
    ...
    brandDirectoryTitle: "品牌介绍",
    brandDirectorySubtitle: "品牌/分类/门店数来自 Google Sheets。",
    brandCategoryLabel: "分类",
    brandStoreLabel: "门店数",
    brandMenuLabel: "收录菜单",
    brandLoading: "正在加载 Google Sheets 数据...",
    brandNotFound: "无匹配数据",
    brandSourcePrefix: "来源",
    brandSourceGoogleSheet: "Google Sheets",
    resultTitle: "你的完美匹配",
    matchScore: "匹配度",
    spiciness: "辣度",
  ...
  ja: {
    ...
    brandDirectoryTitle: "ブランド紹介",
    brandDirectorySubtitle: "ブランド名・分類・店舗数は Google Sheets から取得しています。",
    brandCategoryLabel: "分類",
    brandStoreLabel: "店舗数",
    brandMenuLabel: "掲載メニュー",
    brandLoading: "Google Sheets データを読み込み中...",
    brandNotFound: "該当データなし",
    brandSourcePrefix: "ソース",
    brandSourceGoogleSheet: "Google Sheets",
