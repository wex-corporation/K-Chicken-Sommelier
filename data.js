...
const MENU_DESCRIPTION_TRANSLATIONS = {
  "뿌링클": {
    en: "Chicken sprinkled with seasoning containing blue cheese, cheddar cheese, onion, and garlic. Bburring Bburring sauce is a must.",
    zh: "撒有蓝奶酪、切达奶酪、洋葱和大蒜调味粉的炸鸡。必须搭配 Bburring Bburring 酱。",
    ja: "ブルーチーズ、チェダーチーズ、玉ねぎ、にんにくが入ったシーズニングをまぶしたチキン。プンプンソースは必須です。"
  },
  "황금올리브치킨": {
    en: "The standard of fried chicken, crispy and juicy, using the finest extra virgin olive oil.",
    zh: "炸鸡的标准，使用顶级特级初榨橄榄油，口感香脆多汁。",
    ja: "最高級のエキストラバージンオリーブオイルを使用した、サクサクで肉汁たっぷりのフライドチキンの定番。"
  },
  "허니콤보": {
    en: "Kyochon's signature thin, crunchy batter coated in honey sauce. Stays crispy without getting soggy.",
    zh: "校村特有的薄而脆的炸衣，裹上蜂蜜酱。持久酥脆，不会变软。",
    ja: "キョチョン特有の薄くて硬い衣にハニーソースを絡めた、時間が経っても冷めても美味しいサクサク感。"
  },
  "고추바사삭": {
    en: "Oven-baked chicken with Cheongyang pepper powder. Known for being served with Marbleing and Gobleing sauces.",
    zh: "裹上青阳辣椒粉后在烤箱中烘烤。特点是搭配大理石酱和戈布林酱食用。",
    ja: "青陽唐辛子パウダーをまぶしてオーブンで焼いた、マーブリングソースとゴブリングソースと一緒に食べるのが特徴。"
  }
};
...
const UI_STRINGS = {
  en: {
    ...
    seeTopPicks: "See Today's Picks",
    premiumUnlocks: "Premium Benefits",
    questionProgress: "Question {curr} of {total}",
    statsTemplate: "Analyzing <strong>{brands} Brands</strong> & <strong>{menus} Menus</strong> 📊 <span style=\"font-size: 11px; color: #999; margin-left: 5px;\">(Real-time: {today})</span>",
    lockedTitle: "Premium Unlocks",
    lockedItem1: "Group Order Plan — Mix 2–6 tastes. No drama.",
    lockedItem2: "Deal Finder — Best sets, faster.",
    lockedItem3: "Full Pairing Report — Sides + drinks that just work.",
    lockedItem4: "Regret Radar — Know dealbreakers before you order.",
    premiumHeroTitle: "Go Full Sommelier",
    premiumHeroSub: "Start free for 1 month. Upgrade your orders instantly.",
    feature1: "Group Order Mode",
    feature2: "Deal Finder",
    feature3: "Full Pairing Report",
    feature4: "Regret Radar",
    feature5: "Taste History",
    pricingNote: "First month free. Then $4.99/month. Cancel anytime.",
    noAccount: "No picks yet.",
    // New Strings
    headerSettings: "Settings",
    headerPremium: "Premium",
    todaysWeekly: "Today's picks updated weekly",
    topPick: "Top Pick",
    lowMess: "Low Mess",
    bestValue: "Best Value",
    pricingBig: "First month free",
    pricingSmall: "Then $4.99/month",
    pricingMicro: "Cancel anytime",
    trustSecure: "Secure checkout",
    trustNoHidden: "No hidden fees",
    trustCancel: "Cancel anytime",
    faqQ1: "When do I get charged?",
    faqA1: "After your free month ends. If you cancel before then, you won't be charged anything.",
    faqQ2: "Can I cancel during the free month?",
    faqA2: "Yes. You won't be charged if you cancel before your free trial ends.",
    settingsTitle: "My Taste",
    settingsProfile: "Your Taste Profile",
    settingsEditQuiz: "Edit Taste Quiz",
    settingsHistory: "Taste History",
    settingsFeedback: "Feedback",
    settingsLabelFeedback: "Send feedback",
    settingsLabelIssue: "Report an issue",
    settingsLang: "Language",
    shareModalTitle: "Share your result",
    shareModalSub: "Text and hashtags are auto-generated.",
    shareCopy: "Copy Link",
    // Teaser Cards
    teaserTitle1: "Kyochon Original",
    teaserTitle2: "Golden Olive",
    teaserTitle3: "Ppuringkle",
    teaserSub1: "The classic soy garlic choice",
    teaserSub2: "Extra crispy, extra juicy",
    teaserSub3: "BHC's signature cheese flavor"
  },
  ko: {
    startBtn: "나의 치킨 찾기",
    heroHeadline: "나의 치킨 소울메이트 찾기 🍗",
    heroSub: "30초 퀴즈로 당신의 입맛에 딱 맞는 치킨 브랜드를 찾아보세요.",
    resultsTitle: "당신의 완벽한 매치",
    matchScore: "일치도",
    spiciness: "매운맛",
    crispiness: "바삭함",
    flavor: "맛 특징",
    ...
    seeTopPicks: "오늘의 추천 메뉴 보기",
    premiumUnlocks: "프리미엄 혜택",
    questionProgress: "{total}문제 중 {curr}번",
    statsTemplate: "현재 <strong>{brands}개 브랜드</strong>, <strong>{menus}개 메뉴</strong> 분석 완료 📊 <span style=\"font-size: 11px; color: #999; margin-left: 5px;\">(실시간 DB: {today})</span>",
    lockedTitle: "프리미엄 잠금해제",
    lockedItem1: "단체 주문 플랜 — 2~6개 맛 믹스. 갈등 제로.",
    lockedItem2: "딜 파인더 — 최적의 세트 메뉴, 더 빠르게.",
    lockedItem3: "풀 페어링 리포트 — 찰떡궁합 사이드 + 음료.",
    lockedItem4: "후회 레이더 — 주문 전 지뢰 메뉴 감지.",
    premiumHeroTitle: "풀 소믈리에가 되어보세요",
    premiumHeroSub: "1개월 무료 체험 후 즉시 주문 업그레이드.",
    feature1: "단체 주문 모드",
    feature2: "딜 파인더",
    feature3: "풀 페어링 리포트",
    feature4: "후회 레이더",
    feature5: "취향 히스토리",
    pricingNote: "첫 달 무료. 이후 월 $4.99. 언제든 해지 가능.",
    noAccount: "아직 기록이 없습니다.",
    // New Strings
    headerSettings: "설정",
    headerPremium: "프리미엄",
    todaysWeekly: "매주 업데이트되는 오늘의 추천",
    topPick: "인기 메뉴",
    lowMess: "깔끔한 구성",
    bestValue: "최고의 가성비",
    pricingBig: "첫 달 무료 체험",
    pricingSmall: "이후 월 $4.99",
    pricingMicro: "언제든 해지 가능",
    trustSecure: "보안 결제",
    trustNoHidden: "숨겨진 수수료 없음",
    trustCancel: "자유로운 해지",
    faqQ1: "결제는 언제 되나요?",
    faqA1: "무료 체험 기간이 끝난 후 결제됩니다. 그 전에 해지하시면 비용이 발생하지 않습니다.",
    faqQ2: "무료 기간 중에도 해지 가능한가요?",
    faqA2: "네, 언제든지 가능합니다. 무료 체험 종료 전까지는 비용이 청구되지 않습니다.",
    settingsTitle: "나의 취향",
    settingsProfile: "나의 취향 프로필",
    settingsEditQuiz: "취향 퀴즈 수정",
    settingsHistory: "취향 히스토리",
    settingsFeedback: "피드백",
    settingsLabelFeedback: "피드백 보내기",
    settingsLabelIssue: "오류 제보",
    settingsLang: "언어 설정",
    shareModalTitle: "결과 공유하기",
    shareModalSub: "멘트와 해시태그가 자동 입력됩니다.",
    shareCopy: "링크 복사",
    // Teaser Cards
    teaserTitle1: "교촌 오리지날",
    teaserTitle2: "BBQ 황금올리브",
    teaserTitle3: "bhc 뿌링클",
    teaserSub1: "전설의 마늘 간장 치킨",
    teaserSub2: "후라이드의 교과서, 바삭한 올리브",
    teaserSub3: "설명이 필요 없는 시즈닝 치킨의 1위"
  },
  zh: {
    startBtn: "寻找我的炸鸡伴侣",
    ...
    questionProgress: "第 {curr} / {total} 题",
    statsTemplate: "正在分析 <strong>{brands} 个品牌</strong> 和 <strong>{menus} 个菜单</strong> 📊 <span style=\"font-size: 11px; color: #999; margin-left: 5px;\">(实时数据: {today})</span>",
    lockedTitle: "高级版福利",
    lockedItem1: "团体订购计划 — 混合 2–6 种口味，告别纠结。",
    lockedItem2: "特惠发现家 — 极速发现最优套餐。",
    lockedItem3: "完整搭配报告 — 绝配侧边菜 + 饮品。",
    lockedItem4: "后悔雷达 — 下单前识别雷区。",
    premiumHeroTitle: "成为全职炸鸡 소믈리에",
    premiumHeroSub: "免费试用 1 个月，立即升级您的订餐体验。",
    feature1: "团体订购模式",
    feature2: "特惠发现家",
    feature3: "完整搭配报告",
    feature4: "后悔雷达",
    feature5: "口味历史",
    pricingNote: "首月免费。之后每月 $4.99。可随时取消。",
    noAccount: "暂无记录。",
    // New Strings
    headerSettings: "设置",
    headerPremium: "高级版",
    todaysWeekly: "今日推荐每周更新",
    topPick: "人气推荐",
    lowMess: "干净利落",
    bestValue: "高性价比",
    pricingBig: "首月免费试用",
    pricingSmall: "之后每月 $4.99",
    pricingMicro: "可随时取消",
    trustSecure: "安全结账",
    trustNoHidden: "无隐藏费用",
    trustCancel: "随时取消",
    faqQ1: "什么时候开始收费？",
    faqA1: "免费试用月结束后。在此之前取消，不会产生任何费用。",
    faqQ2: "免费试用期间可以取消吗？",
    faqA2: "可以。在免费试用结束前取消不会被收费。",
    settingsTitle: "我的口味",
    settingsProfile: "我的口味档案",
    settingsEditQuiz: "编辑口味测试",
    settingsHistory: "口味历史",
    settingsFeedback: "反馈",
    settingsLabelFeedback: "提供反馈",
    settingsLabelIssue: "报告问题",
    settingsLang: "语言",
    shareModalTitle: "分享结果",
    shareModalSub: "文字和标签已自动生成。",
    shareCopy: "复制链接",
    // Teaser Cards
    teaserTitle1: "校村原味",
    teaserTitle2: "BBQ 黄金橄榄",
    teaserTitle3: "BHC 薯条克",
    teaserSub1: "经典的蒜酱选择",
    teaserSub2: "超脆，超多汁",
    teaserSub3: "BHC 招牌芝士风味"
  },
  ja: {
    startBtn: "私のチキンを探す",
    heroHeadline: "あなたのチキン・ソウルメイトを探そう 🍗",
    heroSub: "30秒のクイズで、あなたの好みにぴったりの韓国チキンブランドを見つけましょう。",
    resultsTitle: "あなたにぴったりのチキン",
    matchScore: "マッチ度",
    spiciness: "辛さ",
    crispiness: "サクサク感",
    flavor: "風味",
    ...
    questionProgress: "第 {curr} / {total} 問",
    statsTemplate: "現在 <strong>{brands}個のブランド</strong>、<strong>{menus}個のメニュー</strong>を分析中 📊 <span style=\"font-size: 11px; color: #999; margin-left: 5px;\">(リアルタイム: {today})</span>",
    lockedTitle: "プレミアム特典",
    lockedItem1: "グループ注文プラン — 2〜6種類の味をミックス。",
    lockedItem2: "ディールファインダー — 最適なセットを素早く発見。",
    lockedItem3: "フルペアリングレポート — 相性抜群のサイド＋ドリンク。",
    lockedItem4: "後悔レーダー — 注文前に地雷メニューを察知。",
    premiumHeroTitle: "フルソムリエになろう",
    premiumHeroSub: "1ヶ月間無料。今すぐ注文をアップグレード。",
    feature1: "グループ注文モード",
    feature2: "ディールファインダー",
    feature3: "フルペアリングレポート",
    feature4: "後悔レーダー",
    feature5: "好み履歴",
    pricingNote: "初月無料。以降月額 $4.99。いつでもキャンセル可能。",
    noAccount: "まだ記録がありません。",
    // New Strings
    headerSettings: "設定",
    headerPremium: "プレミアム",
    todaysWeekly: "今日のおすすめは毎週更新されます",
    topPick: "人気メニュー",
    lowMess: "食べやすい",
    bestValue: "最高のコスパ",
    pricingBig: "初月無料トライアル",
    pricingSmall: "以降月額 $4.99",
    pricingMicro: "いつでもキャンセル可能",
    trustSecure: "安全な決済",
    trustNoHidden: "隠れた費用なし",
    trustCancel: "いつでも解約可能",
    faqQ1: "いつ課金されますか？",
    faqA1: "無料期間終了後です。それまでに解約すれば費用はかかりません。",
    faqQ2: "無料期間中でも解約できますか？",
    faqA2: "はい、可能です。無料トライアル終了前であれば請求されません。",
    settingsTitle: "私の好み",
    settingsProfile: "好みプロフィール",
    settingsEditQuiz: "クイズを編集",
    settingsHistory: "好みの履歴",
    settingsFeedback: "フィードバック",
    settingsLabelFeedback: "意見を送る",
    settingsLabelIssue: "問題を報告",
    settingsLang: "言語",
    shareModalTitle: "結果を共有",
    shareModalSub: "テキストとハッシュタグは自動生成されます。",
    shareCopy: "リンクをコピー",
    // Teaser Cards
    teaserTitle1: "キョチョンオリジナル",
    teaserTitle2: "BBQ 黄金オリーブ",
    teaserTitle3: "BHC プリンクル",
    teaserSub1: "伝説のにんにく醤油チキン",
    teaserSub2: "フライドの定番、サクサクオリーブ",
    teaserSub3: "説明不要のシーズニングチキン1位"
  }
};

const BRAND_TRANSLATIONS = {
  "60계치킨": { en: "60-gye Chicken", zh: "60系炸鸡", ja: "60系チキン" },
  "BBQ": { en: "BBQ", zh: "BBQ", ja: "BBQ" },
  "BHC": { en: "BHC", zh: "BHC", ja: "BHC" },
  "KFC": { en: "KFC", zh: "KFC", ja: "KFC" },
  "교촌치킨": { en: "Kyochon Chicken", zh: "校村炸鸡", ja: "キョチョンチキン" },
  "굽네치킨": { en: "Goobne Chicken", zh: "贡乃炸鸡", ja: "グンネチキン" },
  "네이처치킨": { en: "Nature Chicken", zh: "自然炸鸡", ja: "ネイチャーチ킨" },
  "노랑통닭": { en: "Norang Tongdak", zh: "黄色炸鸡", ja: "ノラン・トンダッ" },
  "네네치킨": { en: "Nene Chicken", zh: "NeNe炸鸡", ja: "ネネチ킨" },
  "또봉이통닭": { en: "Ddobongi", zh: "又蓬伊", ja: "ドボンイ・トンダッ" },
  "멕시카나": { en: "Mexicana", zh: "Mexicana", ja: "メキシカーナ" },
  "만석닭강정": { en: "Manseok", zh: "万石", ja: "マンソッ・タッカンジョン" },
  "바른치킨": { en: "Barun Chicken", zh: "正规炸鸡", ja: "バルンチキン" },
  "보드람치킨": { en: "Bodram Chicken", zh: "Bodram炸鸡", ja: "ボドラムチキン" },
  "부아부아": { en: "Bua Bua", zh: "Bua Bua", ja: "ブアブア" },
  "쌀통닭": { en: "Rice Chicken", zh: "米炸鸡", ja: "米チキン" },
  "순수치킨": { en: "Soonsoo Chicken", zh: "纯正炸鸡", ja: "スンスチキン" },
  "오빠닭": { en: "Oppa Dak", zh: "哥哥炸鸡", ja: "オッパダック" },
  "지코바": { en: "Gcova", zh: "芝科巴", ja: "ジコバ" },
  "처갓집양념치킨": { en: "Cheogajip", zh: "妻家店", ja: "チョガッチップ" },
  "푸라닭": { en: "Puradak", zh: "普拉炸鸡", ja: "プラダック" },
  "호식이두마리치킨": { en: "Hosigi", zh: "好植", ja: "ホシギ" }
};
